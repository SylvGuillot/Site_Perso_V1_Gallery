...
$(document).ready(function () {
	...
	parallax.index.onload=function(){
		setRight("features", "Réalisations");
		setLeft("contact", "Contact");
		setBottom("me","A Propos");
		setTop("page1","Compétences");
	};

	parallax.contact.onload=function(){
		setRight("index","Accueil");
		setLeft("contact2","Réseaux");
	};

	parallax.contact2.onload=function(){
	...
	parallax.me.onload=function(){
		...
		setBottom("me2","Mes  services");
	};
	
	parallax.me2.onload=function(){
		setTop("me","A Propos");
	};
